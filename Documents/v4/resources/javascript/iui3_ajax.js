...
addEventListener("click", function(event)
{
	...
	if (link)
	{
		function unselect()
		{
			...
			link.innerHTML = link.getAttribute("data-oldtext");
		}
		...
		else if (link.target == "_replace")
		{
			...
			link.setAttribute("data-oldtext", link.innerHTML);
			link.innerHTML = "<div class='spinner'>...</div>" + link.innerHTML;
